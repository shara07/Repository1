...
public class ReportFunctions   {
	...
	public int tsID;
	public int tcID;						//'This variable is for ID creation for test case
	public int tstpID;					//'This variable is for ID creation for test step
	public String dtPJStartTime;			//'This variable is for project start time creation
	public String dtTSStartTime;			//'This variable is for test suite start time creation
	public String dtTCStartTime;			//'This variable is for testcase start time creation
	public String dtTstpStartTime;			//'This variable is for test step start time creation
	public String dttstpInfoStartTime;		//'This variable is for test step info start time creation
	public String dtPJEndTime;			//'This variable is for project start time creation
	public String dtTSEndTime;			//'This variable is for test suite start time creation
	public String dtTCEndTime;			//'This variable is for testcase start time creation
	public String dtTstpEndTime;			//'This variable is for test step start time creation
	public String dttstpInfoEndTime;		//'This variable is for test step info start time creation
	

	public String xmlSavedLocation = null;			//'This variable is for storing the xml saved location path
	//Document docXml=null;
	public String strTestSuiteName;// = "Test1"; 
	public String strTestCaseName;// = "TestCase1";
	public String strTestStepName;// = "TestStep1";
	public String strStepType = null;
	public String strStatusFlag = "fail";

	public TransformerFactory transformerFactory = null;
	public Transformer transformer = null;
	public DOMSource source = null;
	public StreamResult result = null;
	public Document doc=null;
	public DocumentBuilderFactory dbFactory = null;
	public DocumentBuilder dBuilder = null;
	public String testStatusValue = null;
	public String FinalStatus = null;
	public String StrStepDescription = null;
	public String strStepStatus = null;
	public String ReportSuiteName;
	public String ReportCaseName;
	public String ReportStepName;
	public int iteratorCnt = 0;
	Date dNow = null;
	String hmsTime = null;
	DateFormat hms = new SimpleDateFormat("dd/MM/yyyy hh:mm:ss a");
	public String screenshotFilePath = null; 
	
	private final String MSEC_SINCE_EPOCH = null;
	...
	DriverScript  ds;
	public  String user;
	public String Tsuitename ;
	public String suitename ="Test";
	public String Tcasename;
	public String updstpstatus;
	public String envfilepath = null;
	private String savedlocation;
	public String Tstep = "Tstep";
	public String locator;
	public Element prjElement = null;
	public Element tsElement = null;
	public Element tcElement = null;
	public Element tstpElement = null;
	public String SCellData;
	//public ChromeOptions options;	

	public  void LogRepoter(HashMap<String, String> hmap, String strStepStatus1,String strStepType1,String StrStepDescription1) throws IOException
	{
		...
		if(this.savedlocation == null )
		{
			...
			//long d= date.getDate();
			Date d = cal.getTime();
			//String dateTime = d.toString().replace(" ", "_");
			String dateTime = d.toString().replace(" ", "_").replace(":", "_");					
			File dir = new File(opath+"\\Reports\\"+dateTime);
			dir.mkdir();			
			File srcDir = new File(opath+"/HTMLTemplates/");			
			Path path = Paths.get(opath, "\\Reports\\" + dateTime);
			this.savedlocation = path.toString();
			File destDir = new File(this.savedlocation);
		...
		xmlSavedLocation = Paths.get(this.savedlocation , "\\XmlReport.xml").toString();
		screenshotFilePath = Paths.get(savedlocation, "\\img\\screenshots\\").toString();
...
//		 ReportStepName = strTestStepName;
		...
		try {
			...
			if (exists) {
				AppendRootNode (hmap, dbFactory,dBuilder);
			}
			else{
				CreateRootDirectory(hmap, doc,strTestSuiteName,strTestCaseName,strTestStepName);	  
			}
	...
	public String AppendRootNode (HashMap<String, String> hmap,DocumentBuilderFactory dbFactory,DocumentBuilder dBuilder) {
		try{
			...
			if(iteratorCnt == 0){
			iteratorCnt = 1;
		//	Path path = Paths.get(opath,"\\AutomationReportViewer\\Project\\TestSuite[@Name="+hmap.get(ReportSuiteName)+"'][@ID="+tsID+"]");
...
//			String tstpExpression = "//AutomationReportViewer/Project/TestSuite[@Name='"+hmap.get(ReportSuiteName)+"'][@ID="+tsID+"]/TestCase[@Name='"+hmap.get(ReportCaseName)+"'][@ID="+tcID+"]/TestStep[@Name='"+hmap.get(ReportStepName)+"'][@ID="+tstpID+"]";	   
			...
			if(((tsNodes.getLength()) > 0) && ((hmap.get(ReportSuiteName)).equalsIgnoreCase(strTestSuiteName))){
				...
				//	Element tcElement = null;
					...
					//	Element tstpElement = null;
						...
						strStatusFlag = AppendTestStepLog(hmap, dbFactory,dBuilder, docXml, root, prjElement, tsElement, tcElement, tstpElement);
					}
					else{
						tcElement=(Element)((NodeList)tcNodes).item(0);
						strStatusFlag = AppendTestStep(hmap,dbFactory,dBuilder, docXml, root, prjElement, tsElement, tcElement,strTestStepName);
					}
				}else{
					tsElement=(Element)((NodeList)tsNodes).item(0);
					strStatusFlag = AppendTestCase(hmap,dbFactory,dBuilder, docXml, root, prjElement, tsElement, strTestCaseName, strTestStepName);
				}    	 
			} 
			else{
				prjElement=(Element)((NodeList)prjNodes).item(0);
				strStatusFlag = AppendTestSuite(hmap,dbFactory,dBuilder, docXml, root, prjElement, strTestSuiteName, strTestCaseName,strTestStepName);
			}	        	  
			...
			double sec = timeDifference(dtPJStartTime,dtPJEndTime);
	...
	public String CreateRootDirectory(HashMap<String, String> hmap,Document doc,String strTestSuiteName, String strTestCaseName,String strTestStepName) {
		...
		try { 
			...
			strStatusFlag = CreateTestSuite(hmap,dbFactory, dBuilder, doc, rootElement, project, strTestSuiteName, strTestCaseName, strTestStepName);
			Date dnowe = new Date();
	...
	public String CreateTestSuite(HashMap<String, String> hmap, DocumentBuilderFactory dbFactory,DocumentBuilder dBuilder, Document doc, Element rootElement, Element project, String strTestSuiteName, String strTestCaseName, String strTestStepName)    {
		try { 
			...
			strStatusFlag = CreateTestCase(hmap,dbFactory,dBuilder, doc, rootElement, project, testSuite, strTestCaseName,strTestStepName);
			Date dnowe = new Date();
			...
			double sec = timeDifference(dtTSStartTime,dtTSEndTime);
	...
	public String CreateTestCase(HashMap<String, String> hmap, DocumentBuilderFactory dbFactory,DocumentBuilder dBuilder, Document doc, Element rootElement, Element project, Element testSuite,String strTestCaseName,String strTestStepName)    {
		try { 
			...
			strStatusFlag = CreateTestStep(hmap,dbFactory,dBuilder, doc, rootElement, testCase,strTestStepName);
			Date dnowe = new Date();
			...
			double sec = timeDifference(dtTCStartTime,dtTCEndTime);
	...
	public String CreateTestStep(HashMap<String, String> hmap, DocumentBuilderFactory dbFactory,DocumentBuilder dBuilder, Document doc, Element rootElement, Element testCase,String strTestStepName)    {
		try { 
			...
			strStatusFlag = CreateTestStepLog(hmap,dbFactory,dBuilder, doc, rootElement, testStep);
			Date dnowe = new Date();
			...
			double sec = timeDifference(dtTstpStartTime,dtTstpEndTime);
	...
	public String CreateTestStepLog(HashMap<String, String> hmap, DocumentBuilderFactory dbFactory,DocumentBuilder dBuilder, Document doc, Element rootElement, Element testStep)    {
		try { 
...
//			}
			...
			double sec = timeDifference(dttstpInfoStartTime,dttstpInfoEndTime);
	...
	public String AppendTestSuite(HashMap<String, String> hmap, DocumentBuilderFactory dbFactory,DocumentBuilder dBuilder, Document doc, Element rootElement, Element project, String strTestSuiteName, String strTestCaseName,String strTestStepName)    {
		try { 
	...
	public String AppendTestCase(HashMap<String, String> hmap, DocumentBuilderFactory dbFactory,DocumentBuilder dBuilder, Document doc, Element rootElement, Element project,  Element testSuite, String strTestCaseName,String strTestStepName)    {
		try { 
			if(hmap.containsKey(ReportCaseName)){
			...
			Attr suiteDuration = doc.createAttribute("Duration");
			double tssec = timeDifference(dtTSStartTime,dtTSEndTime);
	...
	public String AppendTestStep(HashMap<String, String> hmap, DocumentBuilderFactory dbFactory,DocumentBuilder dBuilder, Document doc, Element rootElement, Element project, Element testSuite, Element testCase, String strTestStepName)    {
		try {
			if(hmap.containsKey(ReportStepName)){
			...
			Attr caseDuration = doc.createAttribute("Duration");
			double tcsec = timeDifference(dtTCStartTime,dtTCEndTime);
...
//			}
	...
	public String AppendTestStepLog(HashMap<String, String> hmap, DocumentBuilderFactory dbFactory,DocumentBuilder dBuilder, Document doc, Element rootElement, Element project, Element testSuite, Element testCase, Element testStep)    {
		try { 
			...
			testStep.setAttributeNode(stepFinalStatus);
			Attr stepDuration = doc.createAttribute("Duration");
			double tstpsec = timeDifference(dtTstpStartTime,dtTstpEndTime);
...
//			}
	...
	public String captureScreenShot(String ssfilePath) {
		try {
			final long MSEC_SINCE_EPOCH = System.currentTimeMillis();
